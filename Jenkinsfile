...
pipeline {
    ...
    environment {
        PROJECT_PATH = "D:\\Slot-FruitCocktail"
    }
        ...
        stage('Checkout') {
            steps {
                script {
                    ...
                    git clone git@github.com:DingDingHouse/Slot-Miner.git D:\\Slot-Miner || echo "Repository already exists, pulling latest changes."
                    cd Slot-Miner
                    git checkout main
                    git fetch --all
